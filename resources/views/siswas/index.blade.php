                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                                <div class="flex justify-center gap-2">
                                    <a href="{{ route('siswas.edit', $siswa) }}"
                                        class="inline-flex items-center px-3 py-1.5 bg-amber-500 hover:bg-amber-600 text-white rounded-lg font-medium text-sm transition-all duration-200">
                                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <form action="{{ route('siswas.destroy', $siswa) }}" method="POST" class="inline-block">
                                        @csrf @method('DELETE')
                                        <button class="inline-flex items-center px-3 py-1.5 bg-red-500 hover:bg-red-600 text-white rounded-lg font-medium text-sm transition-all duration-200"
